...
<div id="header" style="height: 150px;">
    <div>
      ...
      <ul id="navigation">
        <li class="active">
          <a href="doc/doc_allpatients.php">See All Patients</a>
        </li>
        <li >
          <a href="doc/search_p.php">Search Patients</a>
        </li>
        <li>
          <a href="doc/doc_wards.php">Wards</a>
        </li>
        <li>
          <a href="doc/doc_doctors.php">Doctors</a>
        </li>
        <li>
          <a href="doc/doc_tests.php">Tests</a>
        </li>
      </ul>
    </div>
</div>
