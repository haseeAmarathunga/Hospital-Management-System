...
<div id="header" style="height: 150px;">
    <div>
      ...
      <ul id="navigation">
        <li class="active">
          <a href="cons/doc_allpatients.php">See All Patients</a>
        </li>
        <li >
          <a href="cons/search_p.php">Search Patients</a>
        </li>
        <li>
          <a href="cons/doc_wards.php">Wards</a>
        </li>
        <li>
          <a href="cons/cons_consultants.php">Consultants</a>
        </li>
        <li>
          <a href="cons/h_tests.php">Tests</a>
        </li>
      </ul>
    </div>
</div>
